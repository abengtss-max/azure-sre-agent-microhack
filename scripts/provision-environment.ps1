...
# Every run gets a unique 4-char suffix so multiple microhacks can safely share one
# subscription. -ResourceGroup sets the base name; the suffix is always appended.
